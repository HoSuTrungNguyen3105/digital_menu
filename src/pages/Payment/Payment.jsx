...
import MomoImg from "../../assets/MOMO-Logo-App.png";
                ...
                <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
                    ...
                    <div className="p-8">
                        ...
                        <button
                            ...
                            className={`w-full py-4 rounded-xl font-bold text-lg text-white shadow-lg transition-all ${isMethodForm
                            ...
                            <div className="mb-8">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div
                                        ...
                                        className={`cursor-pointer p-4 rounded-xl border-2 transition-all flex items-center justify-between ${paymentMethod === "momo"
                                    ...
                                    >
                                        <div className="flex items-center gap-3">
                                            ...
                                            />
                                            <span className="font-bold text-gray-700">MoMo Wallet</span>
                                        </div>
                                        {paymentMethod === "momo" && (
                                    ...
                                    <div
                                        ...
                                        className={`cursor-pointer p-4 rounded-xl border-2 transition-all flex items-center justify-between ${paymentMethod === "vnpay"
                        ...
                        <button
                            ...
                            className={`w-full py-4 rounded-xl font-bold text-lg text-white shadow-lg transition-all ${isProcessing
                                ? "bg-gray-400 cursor-not-allowed"
                                : paymentMethod === "momo"
                                    ? "bg-pink-600 hover:bg-pink-700"
                                    : "bg-blue-600 hover:bg-blue-700"
