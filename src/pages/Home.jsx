...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white text-black selection:bg-orange-500 selection:text-white font-sans antialiased">
      {/* NAVBAR */}
      <header className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-orange-100">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4 text-sm font-medium">
            ...
            <Link
              to="/register"
              className="bg-orange-600 text-white px-5 py-2.5 rounded-full hover:bg-orange-700 transition-all shadow-lg shadow-orange-500/20"
            >
              Get Started
            </Link>
          </div>
      ...
      <main>
        ...
        <section className="relative pt-32 pb-20 px-6 overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center">
            <motion.div
              ...
              className="inline-block mb-6 px-4 py-2 bg-orange-100 rounded-full text-sm font-semibold text-orange-700 border border-orange-200"
            >
            ...
            >
              Modern Menus. <br />
              <span className="text-orange-600">Powered by QR.</span>
            </motion.h1>
            ...
            >
              ...
              No apps, no hardware, just a simple scan using fresh digital
              technology.
            </motion.p>
            ...
            >
              <button
                ...
                className="bg-gradient-to-r from-orange-600 to-red-600 text-white px-8 py-4 rounded-xl font-semibold hover:scale-105 transition-transform shadow-lg shadow-orange-500/25"
              >
                View Live Demo →
              </button>
              <Link
                to="/register"
                className="border border-orange-200 bg-white px-8 py-4 rounded-xl font-semibold hover:bg-orange-50 text-gray-700 transition-colors"
              >
                Register Restaurant
              </Link>
            </motion.div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              {STATS.map((stat, i) => (
                ...
                >
                  ...
                  <div className="text-3xl md:text-4xl font-black mb-1 text-gray-900">
                    {stat.value}
                  </div>
        ...
        <section
          id="demo"
          className="h-screen flex items-center bg-gradient-to-br from-orange-50/50 to-white"
        >
          <div className="max-w-6xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative flex justify-center">
              <div className="absolute inset-0 bg-gradient-to-br from-orange-500/20 to-red-500/20 blur-3xl rounded-full scale-75" />
              <div className="relative bg-white border border-gray-100 rounded-[2.5rem] p-12 shadow-2xl shadow-orange-500/10">
                <img
                  src="/scanner.png"
                  alt="QR"
                  className="w-64 h-64 grayscale-0 contrast-125 hover:rotate-2 transition-all duration-500"
                />
              </div>
            </div>
          </div>
        ...
        <section
          id="how-it-works"
          className="relative min-h-screen flex items-center overflow-hidden bg-gradient-to-br from-orange-50 via-white to-gray-100 pt-24"
        >
          {/* Background decorative blur */}
          <div className="absolute -top-32 -left-32 h-96 w-96 rounded-full bg-orange-200/20 blur-3xl" />
          <div className="absolute -bottom-32 -right-32 h-96 w-96 rounded-full bg-red-200/20 blur-3xl" />
            ...
            <div className="grid md:grid-cols-2 gap-12">
              {BENEFITS.map((benefit, i) => (
                <motion.div
                  ...
                  className="bg-gradient-to-br from-orange-50 to-white p-8 rounded-3xl border border-orange-100 hover:shadow-xl hover:shadow-orange-100 transition-all"
                >
        ...
        {/* CTA SECTION */}
        <section className="py-24 bg-gradient-to-br from-orange-600 via-red-600 to-orange-800 text-white relative overflow-hidden">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-4">
                  <Link
                    to="/register"
                    className="bg-white text-orange-600 px-8 py-4 rounded-xl font-semibold hover:scale-105 transition-transform shadow-xl text-center"
                  >
                    Start Free Trial →
                  </Link>
                  <button
                ...
                <p className="text-sm text-orange-200 pt-2">
                  ✨ No credit card required • Cancel anytime
                </p>
              </div>

              <div className="hidden md:block">
                <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-3xl p-8 space-y-4 shadow-2xl">
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 bg-green-400 rounded-full flex items-center justify-center text-black text-sm font-bold">
                      ✓
                    </div>
                    <span className="font-semibold text-lg">Instant Setup</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 bg-green-400 rounded-full flex items-center justify-center text-black text-sm font-bold">
                      ✓
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-orange-600 text-white flex items-center justify-center font-bold rounded-xl">
            ...
            {/* Product */}
            <div>
              <h4 className="font-bold mb-4 text-sm uppercase tracking-wider text-orange-500">
                Product
              </h4>
              <ul className="space-y-3 text-sm text-gray-400">
                ...
                <li>
                  <a href="#demo" className="hover:text-orange-500 transition">
                    Demo
                  </a>
                </li>
                <li>
...
function FeatureCard({ title, desc, icon, gradient, index }) {
  return (
    <motion.div
      ...
      className={`p-8 rounded-3xl border border-gray-100 hover:border-orange-200 hover:shadow-xl hover:shadow-orange-100/50 transition-all duration-300 bg-gradient-to-br ${gradient}`}
    >
